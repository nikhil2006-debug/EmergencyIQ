...
export default function ConversationPanel({ messages, onSendCallerLine, loading }: Props) {
    ...
    return (
        <div className="flex flex-col h-full eiq-card p-5">
            ...
            {/* Messages / Dispatcher Log */}
            <div ref={scrollRef} className="flex-1 overflow-y-auto space-y-3 mb-4 min-h-[200px]">
                {messages.length === 0 && (
                    ...
                    {messages.map((m, i) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 text-[11px] mb-1.5">
                                <span className="font-mono text-[var(--eiq-muted)]">{m.timestamp}</span>
                                {m.speaker === "caller" ? (
                            ...
                            {/* Message Content */}
                            <p
                                className={`text-sm pl-4 py-2 border-l-2 rounded-r-lg transition-colors duration-200 ${
                                    m.speaker === "caller"
